...
2. `{globalFunctionsDir}/memory.md` — global user-defined
3. Built-in `functions/memory.md` shipped with rolebox

`{globalFunctionsDir}` follows the active harness's config dir — see [Supported harnesses](../README.md#supported-harnesses) for the per-harness paths.
