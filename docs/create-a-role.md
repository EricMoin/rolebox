...
The example below uses opencode's config tree; other harnesses use the same role layout under their own config directories — see [Supported harnesses](../README.md#supported-harnesses) for the full table.
