...
Acknowledge the loop startup briefly. Do **not** begin working on the task. The first round is already dispatched — you will receive results shortly.
...
Keep the summary brief — 3-5 sentences. Do not reference internal iteration numbers (the runner manages that). Just describe the round's work.
