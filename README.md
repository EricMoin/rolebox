...
Custom hooks let you attach behavioral extensions to agent lifecycle events — running JavaScript/TypeScript modules when the agent receives a message, invokes a tool, or constructs its system prompt.
