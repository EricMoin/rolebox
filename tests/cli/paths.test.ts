...
// Override any stale mock.module("../../src/cli/paths", ...) from other test files (e.g. registry-client.test.ts)
// Bun v1.3.14 mock.module persists across files, so we must re-mock before importing.
mock.module("../../src/cli/paths", () => ({ ...require("../../src/cli/paths") }));
...
import { getDataDir, getConfigDir, getRolesDir, getSyncTarget, getRolePath } from "../../src/cli/paths";
