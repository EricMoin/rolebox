...
function readDirectory(
  ...
  if (reading.kind === "missing-bound-store") {
    return { kind: "corrupt", dimension: "storage", reason: "bound database is missing or initialization was interrupted; restore the matching database before resuming" };
  }
